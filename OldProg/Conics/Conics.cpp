...
vector2f Cone_Intersect_Distance(vector3f Pixel_Ray, vector3f Direction, vector3f CenterPoint,  float Radius){
	vector2f dist;
	vector3f Eye(0,0,0);
	float Sqrt_Val;
	float a,b,c;
...
holds the value -1*/
void Cone_Dist_Field(vector3f EyePosition, vector3f Direction, 
	...
	for (int w = 0; w < WIDTH; w ++){
		for(int h = 0; h < HEIGHT; h ++){
			...
			DistField[w][h] = Cone_Intersect_Distance (Pixel_Ray, 
...
main(){
	...
	cout << "Please Name the point in the center of the cone:\n";
	cout << "X Vector: ";
	cin >> CenterPoint[0];
	cout << "\n";
	...
	cout << "What would you like the radius of the cone to be at a distance of 1 from the center of the cone?\n";
	cin >> r;
